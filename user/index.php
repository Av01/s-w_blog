...
<body>
   ...
   <header id="top">
      ...
      <div class="row"> 
         <div>
                  <?php echo'<h2>Hey, '.$_SESSION['username']."</h2><br><h5>Today's reading list:</h5>";?>
         </div>         
      </div>
	   ...
	   <nav id="nav-wrap"> 
	   	...
	   	<div class="row">    		            
			       ...
			       <li><a href=<?php echo"profile.php?username=".$_SESSION['username']?>>My Profile</a></li>	     	
   	...
   	<div class="row">
   		...
   		<div id="main" class="eight columns">
            ...
            while($row = $stmt->fetch()){
               ...
               echo'<a href="index.php?liked='.$row['postID'].'"><button>Like</button></a>';
		...
		?>
   		...
   		<div id="sidebar" class="four columns">
            ...
            echo '<h3>'.$_GET['action'].' successfully.</h3>'; 
   } 
   ?>
   				<h3>Categories.</h3> 
   				<ul>
