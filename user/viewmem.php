...
<body>
   ...
   <header id="top">
      ...
      <div class="row"> 
         <div>
                  <?php echo'<h2>Hey, '.$_SESSION['username'];?>
         </div>         
      </div>
   ...
   <div id="content-wrap">
      ...
      <div class="row">
         ...
         <div id="main" class="eight columns">
             <?php
                try {
                     $stmt = $db->prepare('SELECT username FROM blog_members WHERE memberID != 1 AND username != 
                        :curr_user ORDER BY memberID DESC'); 
                     $stmt -> execute(array(':curr_user' => $_SESSION['username']));       
            ...
            echo'<article class="entry">';
               ...
               echo'<header class="entry-header">';
                        ...
                        echo'<h3 class="entry-title">';
                           echo'<a href="profile.php?name='.$row['username'].'" title="">'.$row['username'].'</a>';
                        echo'</h3>';       
